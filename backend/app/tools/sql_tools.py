    ...
    def get_database_schema(self) -> Dict[str, Any]:
        ...
        try:
            ...
            for table_name in table_names:
                ...
                # Get columns
                columns = inspector.get_columns(table_name, schema=self.db_connection.schema)
                ...
                # Get primary keys
                pk_constraint = inspector.get_pk_constraint(table_name, schema=self.db_connection.schema)
                if pk_constraint:
                    table_info["primary_keys"] = pk_constraint.get("constrained_columns", [])
                
                # Get foreign keys
                foreign_keys = inspector.get_foreign_keys(table_name, schema=self.db_connection.schema)
    ...
    def execute_sql(self, sql_query: str) -> Dict[str, Any]:
        ...
        try:
            ...
            result = session.execute(
                text(sql_query).execution_options(max_row_buffer=settings.MAX_QUERY_ROWS)
            )
