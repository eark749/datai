...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('id', sa.String(36), nullable=False),
        sa.Column('db_connection_id', sa.String(36), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('id', sa.String(36), nullable=False),
        sa.Column('user_id', sa.String(36), nullable=False),
        sa.Column('db_connection_id', sa.String(36), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('query_history_id', sa.String(36), nullable=True),
        ...
        sa.Column('chart_types', sa.JSON(), nullable=False, server_default='[]'),
        sa.Column('data_summary', sa.JSON(), nullable=False, server_default='{}'),
        sa.Column('created_at', sa.DateTime(), nullable=False, server_default=sa.text('CURRENT_TIMESTAMP')),
        sa.ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE'),
